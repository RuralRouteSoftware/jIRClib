...
public class SSLIRCConnection extends IRCConnection {
     ...
     *             If SSL is not supported. This is the case if neither JSSE nor J2SE 1.4 or later is installed.
     * @throws SSLNotSupportedException
     *             If SSL is not supported. This is the case if neither JSSE nor J2SE 1.4 or later is installed. This
     *             exception is thrown if no NoClassDefFoundError is thrown.
     * @throws IOException
     ...
     * 
     * @param trustManager
     *            The <code>SSLTrustManager</code> object which is to add.
     ...
     * 
     * @param trustManager
     *            The <code>SSLTrustManager</code> object which is to remove.
    ...
    /**
     * Returns the set <code>SSLTrustManager</code>s. The default <code>SSLTrustManager</code> is an instance of
     * <code>SSLDefaultTrustManager</code>, which is set when you invoke the <code>connect</code> method without having
     * set another <code>SSLTrustManager</code>.
     * 
