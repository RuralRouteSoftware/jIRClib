...
public interface SSLTrustManager {
     ...
     * and return true if it can be validated and is trusted for server SSL authentication.
     * 
     * @param chain
     *            The peer certificate chain.
     * @return <code>true</code> if the server is trusted, <code>false</code> if the server is not trusted.
     */
