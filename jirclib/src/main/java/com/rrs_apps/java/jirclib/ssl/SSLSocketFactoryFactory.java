...
/**
 * Factory for <code>javax.net.ssl.SSLSocketFactory</code>. Firstly tries to creates this object using exclusively the
 * <code>javax.net.ssl.*</code> classes and then tries to do so using the <code>javax.net.ssl.*</code> classes plus the
 * <code>com.sun.net.ssl.*</code> classes.
 * 
...
class SSLSocketFactoryFactory {
    ...
    /**
     * Creates a new <code>SSLSocketFactory</code>. This method first tries to create it using
     * <code>javax.net.ssl.*</code> classes. If this fails, it tries to access the old JSSE classes in
     * <code>com.sun.net.ssl.*</code>.
     * 
     * @throws SSLNotSupportedException
     *             If neither JSSE nor J2SE >= 1.4 are installed.
     * @throws SSLException
     *             If any exception is thrown. It contains all the thrown exception's information.
     * @return A new <code>SSLSocketFactory</code>.
     */
    public static SSLSocketFactory createSSLSocketFactory(SSLTrustManager[] tm) throws SSLException,
    ...
    /**
     * Creates a new <code>SSLSocketFactory</code> using the <code>javax.net.ssl.*</code> classes.
     * 
     * @param tm
     *            The trustmanagers.
     * @return A <code>javax.net.ssl.SSLSocketFactory</code>.
     * @throws ClassNotFoundException
     *             If the classes could not be loaded and accessed properly
    ...
    /**
     * Creates a new <code>SSLSocketFactory</code> using the <code>com.sun.net.ssl.*</code> and
