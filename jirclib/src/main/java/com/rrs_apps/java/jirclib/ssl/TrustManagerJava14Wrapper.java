...
class TrustManagerJava14Wrapper implements javax.net.ssl.X509TrustManager {
    ...
    /**
     * Does nothing if the server is trusted, throws a <code>CertificateException</code> otherwise. This decision is
    ...
    /**
     * Returns <code>true</code> if the server is trusted. This decision is made by the <code>trustManager</code>.
     * 
