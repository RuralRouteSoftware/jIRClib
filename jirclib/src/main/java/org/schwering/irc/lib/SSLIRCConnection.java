 ...
 * <p>
 * Note that this class is <b>deprecated</b>. The SSL supporting classes moved to <code>org.schwering.irc.lib.ssl</code>
 * since IRClib 1.10.
 * <p>
 * The IRC server you want to connect to must accept SSL connections. Otherwise you cannot connect to it with an
 * instance of <code>SSLIRCConnection</code>. IRC servers which accept SSL connections are really very rare, because SSL
 ...
 * this example.
 * <p>
 * <code>TrustManager</code>s can be added and removed until the <code>connect</code> method is invoked. If no
 * <code>TrustManager</code>s are set until then, an {@link org.schwering.irc.lib.SSLDefaultTrustManager} is set
 * automatically. It accepts all X509 certificates.
 * 
 * @deprecated This class has been replaced with <code>org.schwering.irc.lib.ssl.SSLDefaultTrustManager</code>.
...
public class SSLIRCConnection extends IRCConnection {
    ...
    /**
     * The list of <code>TrustManager</code>s. <code>TrustManager</code>s can be added with the
     * <code>addTrustManager</code> method and removed with the <code>removeTrustManager</code> method. If no
     * <code>TrustManager</code> is included, the <code>getTrustManagers</code> method sets an instance of
     ...
     * <code>TrustManager</code>, if you don't want to use the <code>SSLDefaultTrustManager</code> which accepts the
     ...
     * @see #connect()
     */
    public SSLIRCConnection(String host, int[] ports, String pass, String nick, String username,
            String realname) {
     ...
     * @see #connect()
     */
    public SSLIRCConnection(String host, int portMin, int portMax, String pass, String nick, String username,
            String realname) {
    ...
    /**
     * Creates a new <code>SSLSocketFactory</code> on whose base a new <code>SSLSocket</code> can be created. This
     * method is used by the <code>connect</code> method. If a <code>NoSuchAlgorithmException</code>,
     * <code>KeyManagementException</code>, or any other exception is thrown, it's catched a <code>SSLException</code>
     * is thrown. This <code>SSLException</code> contains all information about the exception which was really thrown.<br />
     * <br />
     * If there are now <code>TrustManager</code>s set at the moment, an instance of <code>SSLDefultTrustManager</code>
     * is set automatically.
     * 
     * @throws SSLException
     *             If any exception is thrown. It contains all the thrown exception's information.
     ...
     * Please remind that we're talking here about <code>com.sun.net.ssl.TrustManager</code>s of the JSSE API and not
     * the <code>javax.net.ssl.TrustManager</code>s of the Java 1.4 API!
     * 
     * @param trustManager
     *            The <code>TrustManager</code> object which is to add.
     ...
     * 
     * @param trustManager
     *            The <code>TrustManager</code> object which is to remove.
    ...
    /**
     * Returns the set <code>TrustManager</code>s. The default <code>TrustManager</code> is an instance of
     * <code>SSLDefaultTrustManager</code>, which is set when you invoke the <code>connect</code> method without having
     * set another <code>TrustManager</code>.<br />
     * Please remind that we're talking here about <code>com.sun.net.ssl.TrustManager</code>s of the JSSE API and not
     * the <code>javax.net.ssl.TrustManager</code>s of the Java 1.4 API!
     * 
